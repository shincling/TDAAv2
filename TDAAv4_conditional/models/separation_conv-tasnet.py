...
class TasNet(nn.Module):
    def __init__(self, enc_dim=512, feature_dim=128, sr=8000, win=2, layer=8, stack=3,
        ...
        self.win = int(sr * win / 1000) # 2ms for 16samples in 8k
        self.stride = self.win // 2 #  1ms for 8samples in 8k
