...
from predata_fromList_123 import prepare_data
import bss_test
...
def eval(epoch):
    ...
    # for ___ in range(2):
        ...
        if config.WFM:
            ...
            WFM_mask=feas_tgt_square/feas_tgt_square_sum
        ...
        '''
        if 1 or batch_idx<=(500/config.batch_size): #only the former batches counts the SDR
            # predicted_maps=predicted_masks*x_input_map_multi
            predicted_maps= Variable(WFM_mask)*x_input_map_multi
